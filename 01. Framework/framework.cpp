...
void GameFramework::KeyboardEvent(UINT message, WPARAM wParam)
{
	m_scene->KeyboardEvent(message, wParam);
}

void GameFramework::MouseWheelEvent(WPARAM wParam)
{
	m_scene->MouseWheelEvent(wParam);
}
